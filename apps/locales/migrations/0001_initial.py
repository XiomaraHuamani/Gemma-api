...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='local',
            name='subnivel_de',
            field=models.ForeignKey(blank=True, help_text='Zona principal que tiene subniveles.', limit_choices_to={'tiene_subniveles': True}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='subnivel_locales', to='locales.zona'),
        ),
        migrations.AddField(
            model_name='local',
            name='zona',
