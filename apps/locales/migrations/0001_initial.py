# Generated by Django 4.2.16 on 2024-12-23 17:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('area', models.FloatField(help_text='Área total en metros cuadrados (ejemplo: 12.5).', validators=[django.core.validators.MinValueValidator(0)])),
                ('perimetro', models.FloatField(help_text='Perímetro en metros (ejemplo: 25.5).', validators=[django.core.validators.MinValueValidator(0)])),
                ('image', models.ImageField(blank=True, help_text='Sube una imagen del local.', null=True, upload_to='metraje_images/')),
                ('estado', models.CharField(choices=[('disponible', 'Disponible'), ('reservado', 'Reservado'), ('vendido', 'Vendido')], default='disponible', help_text='Estado del local.', max_length=20)),
                ('precio', models.DecimalField(decimal_places=2, help_text='Precio del local en moneda local.', max_digits=10, validators=[django.core.validators.MinValueValidator(0)])),
                ('tipo', models.CharField(blank=True, choices=[('entrada segundaria grupo 1 izquierda', 'Entrada segundaria grupo 1 izquierda'), ('entrada segundaria grupo 1 derecha', 'Entrada segundaria grupo 1 derecha'), ('entrada segundaria grupo 2 izquierda', 'Entrada segundaria grupo 2 izquierda'), ('entrada segundaria grupo 2 derecha', 'Entrada segundaria grupo 2 derecha'), ('entrada segundaria grupo 3 izquierda', 'Entrada segundaria grupo 3 izquierda'), ('entrada segundaria grupo 3 derecha', 'Entrada segundaria grupo 3 derecha'), ('entrada segundaria grupo 4 izquierda', 'Entrada segundaria grupo 4 izquierda'), ('entrada segundaria grupo 4 derecha', 'Entrada segundaria grupo 4 derecha'), ('entrada segundaria grupo 5 izquierda', 'Entrada segundaria grupo 5 izquierda'), ('entrada segundaria grupo 5 derecha', 'Entrada segundaria grupo 5 derecha'), ('entrada grupo 1 larga', 'Entrada grupo 1 larga'), ('entrada grupo 2 larga', 'Entrada grupo 2 larga')], help_text='Seleccione el tipo de local.', max_length=36, null=True)),
                ('subnivel_de', models.ForeignKey(blank=True, help_text='Local al que pertenece este subnivel, si aplica.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='subniveles', to='locales.local')),
            ],
            options={
                'verbose_name': 'Local',
