    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(blank=True, choices=[('entrada secundaria grupo 1 izquierda', 'Entrada secundaria grupo 1 izquierda'), ('entrada secundaria grupo 1 derecha', 'Entrada secundaria grupo 1 derecha'), ('entrada secundaria grupo 2 izquierda', 'Entrada secundaria grupo 2 izquierda'), ('entrada secundaria grupo 2 derecha', 'Entrada secundaria grupo 2 derecha'), ('entrada secundaria grupo 3 izquierda', 'Entrada secundaria grupo 3 izquierda'), ('entrada secundaria grupo 3 derecha', 'Entrada secundaria grupo 3 derecha'), ('entrada secundaria grupo 4 izquierda', 'Entrada secundaria grupo 4 izquierda'), ('entrada secundaria grupo 4 derecha', 'Entrada secundaria grupo 4 derecha'), ('entrada grupo 1 larga', 'Entrada grupo 1 larga'), ('entrada grupo 2 larga', 'Entrada grupo 2 larga')], help_text='Escoja el tipo', max_length=50, null=True)),
            ],
            options={
                'verbose_name': 'Local',
        ...
        migrations.AddField(
            model_name='local',
            name='parent',
            field=models.ForeignKey(help_text='Escoja el subnivel de la zona', on_delete=django.db.models.deletion.CASCADE, related_name='locales_parent', to='locales.zona'),
        ),
        migrations.AddField(
            model_name='local',
            name='precio_base',
