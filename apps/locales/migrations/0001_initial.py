# Generated by Django 4.2.16 on 2024-11-23 17:53
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('precio', models.DecimalField(decimal_places=2, help_text='Monto del precio base', max_digits=10)),
            ],
        ),
        migrations.CreateModel(
            name='TipoVenta',
        ...
        migrations.AddField(
            model_name='local',
            name='precio',
            field=models.ForeignKey(help_text='Selecciona un precio base o ajusta manualmente', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='locales', to='locales.preciobase'),
        ),
        migrations.AddField(
            model_name='local',
            name='zona',
