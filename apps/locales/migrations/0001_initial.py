# Generated by Django 4.2.16 on 2024-11-21 23:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria', models.ForeignKey(help_text='Categoría asociada a esta zona', on_delete=django.db.models.deletion.CASCADE, related_name='descuentos', to='locales.categoria')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('precio', models.DecimalField(decimal_places=2, help_text='Precio del local (editable por el usuario)', max_digits=10)),
            ],
        ),
        migrations.CreateModel(
            name='Metraje',
        ...
        migrations.AddField(
            model_name='descuento',
            name='tipo_descuento',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='descuentos', to='locales.tipodescuento'),
        ),
        migrations.CreateModel(
            name='Cliente',
            fields=[
